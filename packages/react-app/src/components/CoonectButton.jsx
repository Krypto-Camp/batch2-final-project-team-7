...
export default function CoonectButton({
  ...
  const logos = {
    ...
    CoinbaseWallet: 'https://play-lh.googleusercontent.com/PjoJoG27miSglVBXoXrxBSLveV6e3EeBPpNY55aiUUBM9Q1RCETKCOqdOkX2ZydqVf0',
  };
  ...
  return (
    <div className="">
      {connectData.connectors.map((connector) => (
        <>
        <div
          className={"button button-style-connect " + (connectData.connected ? "d-none" : "")}
          key={connector.id}
          onClick={() => connect(connector)}
        >
          <div className="button-link px-4 py-2 border-round-10px d-flex align-items-center">
            <img className="button-icon me-2" height={24} src={logos[connector.name.replace(' ', '')]} alt="" />
            <span className="button-text body_18 text-paper fw-500 font-Rubik">
              {connector.name}
            </span>
        ...
        <div
          className={"button button-style-disconnect " + (connectData.connected ? "" : "d-none")}
          onClick={disconnect}
        >
          <div className="button-link px-4 py-2 border-round-10px d-flex align-items-center">
            <div></div>
